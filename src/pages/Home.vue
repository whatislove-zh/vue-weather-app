...
<template>
    <main class="main">
        ...
        <div v-show="favoriteOverload" class="error-modal">
            <h2 class="error-message">Your favorite list if overload, max number of favorite city is 5(five)</h2>
        ...
        <div v-show="homeOverload" class="error-modal">
            <h2 class="error-message">Your city list if overload, max number of city is 5(five)</h2>
